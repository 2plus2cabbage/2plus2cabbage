...
#### GCP
- [terraform-gcp-paloalto-base](https://github.com/2plus2cabbage/terraform-gcp-paloalto-base) • Deploy a Palo Alto Firewall to GCP • [📺 Video](https://youtu.be/ygyQLTfWKW0)
